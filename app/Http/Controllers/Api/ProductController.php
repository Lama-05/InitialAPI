...
use App\Http\Resources\ProductWithCategory as ResourcesProductWithCategory;
...
class ProductController extends BaseController
{
    ...
    public function index()
    {
        ...
        // return $this->sendSuccessResponse(ResourcesProductWithCategory::collection($products), 'Product fetched succeffully!');
        return ResourcesProductWithCategory::collection($products);
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendSuccessResponse(new ResourcesProductWithCategory($outputproduct), 'Product Added Successfully!');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendSuccessResponse(new ResourcesProductWithCategory($product), 'Product fetched Successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $outputproduct = Product::find($product->id);
        return $this->sendSuccessResponse(new ResourcesProductWithCategory($outputproduct), 'Product Edited Successfully!');
    }
